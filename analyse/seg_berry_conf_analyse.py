...
# 预测视频
result = model.predict(source=video_path, iou=0.7, conf=0.1, save=False, agnostic_nms=True)
...
plt.savefig('aiwei_1_Conf.png', dpi=300, bbox_inches='tight')  # IOU_dists ReID_dists
# plt.show()
plt.close()
print("save succeed")
